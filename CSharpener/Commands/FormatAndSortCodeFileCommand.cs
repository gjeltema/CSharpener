...
namespace Gjeltema.CSharpener.Commands
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class FormatAndSortCodeFileCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        public const int CommandId = 0x0767;
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FormatAndSortCodeFileCommand"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private FormatAndSortCodeFileCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static FormatAndSortCodeFileCommand Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new FormatAndSortCodeFileCommand(package, commandService);
        }
